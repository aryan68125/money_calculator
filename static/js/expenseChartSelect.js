...
const myChart_container = document.getElementById('myChart_container');
...
const myChart2_container = document.getElementById('myChart2_container');
...
const myChart3_container = document.getElementById('myChart3_container');
...
document.getElementById("pastOneMonth").addEventListener("click", function() {
  ...
  myChart_container.style.display = 'block';
...
document.getElementById("pastSixMonths").addEventListener("click", function() {
  ...
  myChart2_container.style.display = 'block';
...
document.getElementById("pastTwelveMonths").addEventListener("click", function() {
  ...
  myChart3_container.style.display = 'block';
