...
const renderChart_past_six_months = (data ,labels)=>{
...
const getChartData2 = ()=>{
  console.log('get past 6 month summary');
  ...
  fetch('/income/summary_past_six_months')
    .then((res) => res.json())
    .then((results) => {
      console.log('past 6 month summary results',results);
      ...
      renderChart_past_six_months(data,labels);
    });
};
